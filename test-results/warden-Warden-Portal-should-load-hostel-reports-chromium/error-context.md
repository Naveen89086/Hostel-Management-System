...
- Name: warden.spec.ts >> Warden Portal >> should load hostel reports
- Location: tests\warden.spec.ts:46:7
...
Locator: locator('h1:has-text("Hostel Reports")')
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for locator('h1:has-text("Hostel Reports")')
